...
public final class FragmentListBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView poiRecycleView;

  private FragmentListBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView poiRecycleView) {
    this.rootView = rootView;
    this.poiRecycleView = poiRecycleView;
  }
  ...
  public static FragmentListBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.poi_recycle_view;
      RecyclerView poiRecycleView = ViewBindings.findChildViewById(rootView, id);
      if (poiRecycleView == null) {
        break missingId;
      }

      return new FragmentListBinding((ConstraintLayout) rootView, poiRecycleView);
    }
